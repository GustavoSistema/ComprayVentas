        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un panel de clientes le permite recopilar y visualizar fácilmente los datos de los clientes optimizando <br>
                        la experiencia del cliente, asegurando la retención del mismo. </p>
                </div>
                <div>
                    <a href="{{ route('customers.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus mr-3"></i>AddCliente</a>
                    <a href="{{ route('customers.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash mr-3"></i>Clear</a>
                </div>
            </div>
        </div>
