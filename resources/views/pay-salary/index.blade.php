        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un panel de salarios le permite recopilar y visualizar fácilmente datos salariales optimizando <br>
                        la experiencia salarial, garantizando la retención del salario. </p>
                </div>
                <div>
