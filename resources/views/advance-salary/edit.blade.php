            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Editar Salario</h4>
                    </div>
                </div>
                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            <div class="form-group col-md-12">
                                <label for="employee_id">Nombre de empleado <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="advance_salary">Salario por adelantado <span class="text-danger">*</span></label>
